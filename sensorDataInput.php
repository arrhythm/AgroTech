<?php
    ...
    if(isset($_POST['submit'])){
        ...
        $farmID = $row['Farm ID'];
        $sensor_id = mysqli_real_escape_string($con, $_POST['sensor_id']);
        $position = mysqli_real_escape_string($con, $_POST['position']);
        mysqli_query($con, "INSERT INTO `Sensor`(`Sensor ID`, `Position`, `Farm ID`)
            VALUES('$sensor_id', '$position', '$farmID')");
